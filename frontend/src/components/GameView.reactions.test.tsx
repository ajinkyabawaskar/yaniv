...
jest.mock('../utils/sound', () => ({
  ...
  preloadAsafSound: jest.fn(),
  stopAsafSound: jest.fn(),
  playWaitingForAsafSound: jest.fn(),
  preloadWaitingForAsafSound: jest.fn(),
  stopWaitingForAsafSound: jest.fn(),
  playAllCardsDiscardedSound: jest.fn(),
  preloadAllCardsDiscardedSound: jest.fn(),
  playAcePickedSound: jest.fn(),
  preloadAcePickedSound: jest.fn(),
